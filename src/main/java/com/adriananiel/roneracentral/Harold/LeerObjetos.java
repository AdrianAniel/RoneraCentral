...
public class LeerObjetos {
    // atributo de la clase para especificar la direccion en el disco del archivo
    // base de datos
    ...
    // metodo principal de la clase para leer el archivo que se paso como parametro
    ...
    public ArrayList<?> Read() throws IOException, ClassNotFoundException {
        ...
        // en el try intenta de crear un stream de datos de entrada convirtiendo los
        // datos del stream del archivo a objetos
        try (ObjectInputStream ois = new ObjectInputStream(fis)) {

            // crea una nueva lista de usuarios vacia
            ArrayList<SuministroTable> suministroList;

            // de los objetos cargados del archivo, los añade a la lista vacia que se creo
            // anteriormente,
