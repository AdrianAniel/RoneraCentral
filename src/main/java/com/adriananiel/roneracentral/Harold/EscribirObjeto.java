...
public class EscribirObjeto {
    ...
    // atributo de las clases para especificar la direccion en el disco del archivo
    // base de datos
    ...
    // metodo principal de la clase el cual escribe en el archivo especificado la
    // lista que le pases como parametro a este metodo
    public void Write(ArrayList<SuministroTable> list) {
        ...
        try {
            ...
            // se crean los stream de salida para primero convertir los objetos al output
            // stream de un archivo y poder escribir en el archivo
