...
public abstract class MateriaPrimaGeneral {
    private String nombre;
    private String cantidadEnAlmacen;
    private LocalDate fechaVencimiento;
    private String direccionImagen;

    public MateriaPrimaGeneral(String nombre, String cantidadEnAlmacen, LocalDate fechaVencimiento, String direccionImagen) {
        this.nombre = nombre;
